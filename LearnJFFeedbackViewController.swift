//
//  LearnJFFeedbackViewController.swift
//  JianSanWallpaper
//
//  Created by 李南君 on 2017/12/4.
...
class JFFeedbackViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        tableView.contentInset = UIEdgeInsets(top: -15, left: 0, right: 0)
    ...
    */
    ...
    /**
     内容文本改变事件
    */
    @objc fileprivate func didChangeValueForContextTextView(_ notification: Notification) {
        changeCommitState()
    }
