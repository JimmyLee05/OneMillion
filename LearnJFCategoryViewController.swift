//
//  LearnJFCategoryViewController.swift
//  JianSanWallpaper
//
...
class JFCategoryViewController: UIViewController {
    ...
    */
    ...
    /**
     点击了最佳锁屏
    */
    @objc fileprivate didTappedBestButton(_ button: UIButton) {
...
extension JFCategoryViewController: UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemsAt indexPath: IndexPath) -> UICollectionViewCell {
